...
class InstructorTest < ActiveSupport::TestCase
  ...
  test 'should have one attached avatar' do
    ...
    assert_kind_of ActiveStorage::Attached::One, instructor.avatar, 'Avatar should be attached'
  end
  ...
  test 'phone format should be valid' do
    ...
    assert_predicate instructor, :valid?, 'Phone format should be valid'
  ...
  test 'email format should be valid' do
    ...
    assert_predicate instructor, :valid?, 'Email format should be valid'
